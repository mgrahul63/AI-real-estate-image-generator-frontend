    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="container px-2 md:px-4 xl:px-0 py-12 mx-auto">
        <div className="text-center ">
          <p className="font-medium text-realState dark:text-indigo-400">
            Contact us
          </p>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
          <div className="p-4 rounded-lg bg-indigo-50 md:p-6 dark:bg-gray-800">
            ...
            <a
              href="mailto:airealestate90@gmail.com"
              className="mt-2 text-sm text-realState dark:text-indigo-400"
            >
