...
const Features = () => {
  return (
    <div className="bg-gray-100">
      <div className="bg-gray-100 relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl py-15 md:px-10 lg:px-20 xl:py-20">
        {/* Image Column */}
        ...
        {/* Text Column */}
        <div className="max-w-lg bg-white lg:max-w-2xl lg:z-10 lg:shadow-lg lg:absolute lg:top-0 lg:w-3/5 lg:left-0 lg:mt-15 lg:ml-10 xl:mt-24 xl:ml-12 md:-mt-15">
          {/* Text Wrapper */}
          <div className="flex flex-col p-10 ">
            ...
            <div className="mt-8 w-[70%]">
              <Link
                to="/dashboard"
                className="w-full md:w-auto py-3 bg-linear-to-r from-[#6464df] to-[#220fce] rounded-sm shadow transition"
              >
