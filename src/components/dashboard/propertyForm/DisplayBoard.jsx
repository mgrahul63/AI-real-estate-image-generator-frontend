      ...
      <div className="p-4">
        ...
        <div className={jsxData ? "hidden" : "block"}>
          ...
          {!loading && createdText && (
            <div className="flex my-4 justify-center bg-white border divide-x rounded-lg rtl:flex-row-reverse">
              <button
                ...
                className="w-1/2 px-4 py-3 text-sm font-semibold text-gray-600 transition-colors duration-200 sm:text-base sm:px-6 hover:bg-indigo-100"
              >
                Save Property
              </button>
          ...
          {!loading && createdText && !jsxData && (
            <div className="my-2">
              <button
                className="bg-white px-4 py-3 text-sm font-semibold text-gray-600 transition-colors duration-200 sm:text-base sm:px-6 hover:bg-indigo-100 w-full"
                onClick={handleGeneratePoster}
              >
                {mediaLoading ? (
                  <span className="animate-pulse">
                    Generating Media Poster...
                  </span>
                ) : (
                  "Generate Social Media Poster"
                )}
        ...
        {jsxData && (
          <button
            className="bg-white mt-2 px-4 py-3 text-sm font-semibold text-gray-600 transition-colors duration-200 sm:text-base sm:px-6 hover:bg-indigo-100 w-full"
