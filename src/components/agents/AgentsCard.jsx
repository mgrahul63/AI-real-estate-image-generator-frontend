    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="container px-6 py-10 mx-auto">
        ...
        <p className="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
          ...
          Estate agents manage property sales and lettings, which can include
          land as well as residential and commercial premises. The role involves
          elements of marketing, sales and administration.
        </p>
